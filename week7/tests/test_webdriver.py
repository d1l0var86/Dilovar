...
from week7.steps.webelement_functions import *
...
# yourpassweb_url = data['scenario1']['web_url']
...
# hover over element
#  explicit waits , and difference between implic t_wait()